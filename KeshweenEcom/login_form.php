				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<form onsubmit="return false" id="login">
							...
							<p><br/></p>
							<a href="customer_reset.php.php?reset=1" style="color:#333; list-style:none;">Forgotten Password</a><input type="submit" class="btn btn-success" style="float:right;" Value="Login">
